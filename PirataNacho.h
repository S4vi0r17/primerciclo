...
#if 0
#define NACHO_USE_ANSI
#endif

#if 0
#define NACHO_STRING_T char*
#endif

#ifndef NACHO_INLINE
	#ifdef _MSC_VER
		#define NACHO_INLINE __inline
	#else
		#define NACHO_INLINE static __inline__
	#endif
#endif
	...
	namespace nacho {
		NACHO_INLINE void locate(int x, int y);
	}
#else
	#include <stdio.h> // for getch() / printf()
	#include <string.h> // for strlen()
	NACHO_INLINE void locate(int x, int y); // Forward declare for C to avoid warnings
#endif // __cplusplus
...
#ifndef gotoxy
/// Function: gotoxy
/// Same as <nacho.locate>.
NACHO_INLINE void gotoxy(int x, int y) {
	#ifdef __cplusplus
	nacho::
	#endif
	locate(x,y);
...
/// under namespace nacho. That is because some platforms have them defined
/// outside of nacho.
namespace nacho {
#endif
 ...
 * NACHO_STRING_T - String type depending on which one of C or C++ is used
 * NACHO_PRINT(str) - Printing macro independent of C/C++
 */

#ifdef __cplusplus
	#ifndef NACHO_STRING_T
		typedef std::string NACHO_STRING_T;
	#endif // NACHO_STRING_T

	#define NACHO_PRINT(st) do { std::cout << st; } while(false)
#else // __cplusplus
	#ifndef NACHO_STRING_T
		typedef const char* NACHO_STRING_T;
	#endif // NACHO_STRING_T

	#define NACHO_PRINT(st) printf("%s", st)
#endif // __cplusplus
 ...
 */
const NACHO_STRING_T ANSI_CLS                = "\033[2J\033[3J";
const NACHO_STRING_T ANSI_CONSOLE_TITLE_PRE  = "\033]0;";
const NACHO_STRING_T ANSI_CONSOLE_TITLE_POST = "\007";
const NACHO_STRING_T ANSI_ATTRIBUTE_RESET    = "\033[0m";
const NACHO_STRING_T ANSI_CURSOR_HIDE        = "\033[?25l";
const NACHO_STRING_T ANSI_CURSOR_SHOW        = "\033[?25h";
const NACHO_STRING_T ANSI_CURSOR_HOME        = "\033[H";
const NACHO_STRING_T ANSI_BLACK              = "\033[22;30m";
const NACHO_STRING_T ANSI_RED                = "\033[22;31m";
const NACHO_STRING_T ANSI_GREEN              = "\033[22;32m";
const NACHO_STRING_T ANSI_BROWN              = "\033[22;33m";
const NACHO_STRING_T ANSI_BLUE               = "\033[22;34m";
const NACHO_STRING_T ANSI_MAGENTA            = "\033[22;35m";
const NACHO_STRING_T ANSI_CYAN               = "\033[22;36m";
const NACHO_STRING_T ANSI_GREY               = "\033[22;37m";
const NACHO_STRING_T ANSI_DARKGREY           = "\033[01;30m";
const NACHO_STRING_T ANSI_LIGHTRED           = "\033[01;31m";
const NACHO_STRING_T ANSI_LIGHTGREEN         = "\033[01;32m";
const NACHO_STRING_T ANSI_YELLOW             = "\033[01;33m";
const NACHO_STRING_T ANSI_LIGHTBLUE          = "\033[01;34m";
const NACHO_STRING_T ANSI_LIGHTMAGENTA       = "\033[01;35m";
const NACHO_STRING_T ANSI_LIGHTCYAN          = "\033[01;36m";
const NACHO_STRING_T ANSI_WHITE              = "\033[01;37m";
const NACHO_STRING_T ANSI_BACKGROUND_BLACK   = "\033[40m";
const NACHO_STRING_T ANSI_BACKGROUND_RED     = "\033[41m";
const NACHO_STRING_T ANSI_BACKGROUND_GREEN   = "\033[42m";
const NACHO_STRING_T ANSI_BACKGROUND_YELLOW  = "\033[43m";
const NACHO_STRING_T ANSI_BACKGROUND_BLUE    = "\033[44m";
const NACHO_STRING_T ANSI_BACKGROUND_MAGENTA = "\033[45m";
const NACHO_STRING_T ANSI_BACKGROUND_CYAN    = "\033[46m";
const NACHO_STRING_T ANSI_BACKGROUND_WHITE   = "\033[47m";
...
NACHO_INLINE int nb_getch(void) {
...
///
/// See <Color Codes>
NACHO_INLINE NACHO_STRING_T getANSIColor(const int c) {
	switch (c) {
...
///
/// See <Color Codes>
NACHO_INLINE NACHO_STRING_T getANSIBackgroundColor(const int c) {
	switch (c) {
...
///
/// See <Color Codes>
NACHO_INLINE void setColor(int c) {
#if defined(_WIN32) && !defined(NACHO_USE_ANSI)
...
///
/// See <Color Codes>
NACHO_INLINE void setBackgroundColor(int c) {
#if defined(_WIN32) && !defined(NACHO_USE_ANSI)
	HANDLE hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
	CONSOLE_SCREEN_BUFFER_INFO csbi;
...
#else
	NACHO_PRINT(getANSIBackgroundColor(c));
#endif
}
...
/// See <Color Codes>
/// See <resetColor>
NACHO_INLINE int saveDefaultColor(void) {
#if defined(_WIN32) && !defined(NACHO_USE_ANSI)
...
#else
	NACHO_PRINT(ANSI_CLS);
	NACHO_PRINT(ANSI_CURSOR_HOME);
#endif
}
...
#ifdef __cplusplus
NACHO_INLINE void setString(const NACHO_STRING_T & str_) {
	const char * const str = str_.data();
	unsigned int len = str_.size();
#else // __cplusplus
NACHO_INLINE void setString(NACHO_STRING_T str) {
...
NACHO_INLINE void setChar(char ch) {
	const char buf[] = {ch, 0};
	setString(buf);
}
...
NACHO_INLINE void setCursorVisibility(char visible) {
#if defined(_WIN32) && !defined(NACHO_USE_ANSI)
	HANDLE hConsoleOutput = GetStdHandle( STD_OUTPUT_HANDLE );
...
#else // _WIN32 || USE_ANSI
	NACHO_PRINT((visible ? ANSI_CURSOR_SHOW : ANSI_CURSOR_HIDE));
#endif // _WIN32 || USE_ANSI
}

/// Function: hidecursor
/// Hides the cursor.
NACHO_INLINE void hidecursor(void) {
	setCursorVisibility(0);
}

/// Function: showcursor
/// Shows the cursor.
NACHO_INLINE void showcursor(void) {
	setCursorVisibility(1);
}

/// Function: msleep
/// Waits given number of milliseconds before continuing.
NACHO_INLINE void msleep(unsigned int ms) {
#ifdef _WIN32
	Sleep(ms);
#else
...
template <class T> void anykey(const T& msg) {
	NACHO_PRINT(msg);
#else
NACHO_INLINE void anykey(NACHO_STRING_T msg) {
	if (msg)
		NACHO_PRINT(msg);
#endif // __cplusplus
	getch();
...
NACHO_INLINE void setConsoleTitle(NACHO_STRING_T title) {
...
#else
	NACHO_PRINT(ANSI_CONSOLE_TITLE_PRE);
	NACHO_PRINT(true_title);
	NACHO_PRINT(ANSI_CONSOLE_TITLE_POST);
#endif // defined(_WIN32) && !defined(NACHO_USE_ANSI)
}
...
#ifdef __cplusplus
/// Class: CursorHider
/// RAII OOP wrapper for <nacho.hidecursor>.
